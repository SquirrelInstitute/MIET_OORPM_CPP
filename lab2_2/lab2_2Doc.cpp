...
// lab2_2Doc.cpp : implementation of the Clab22Doc class
//
...
void Clab22Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void Clab22Doc::InitializeSearchContent()
{
...
void Clab22Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
